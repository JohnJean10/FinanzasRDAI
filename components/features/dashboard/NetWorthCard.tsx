...
import { TransferModal } from "@/components/features/transactions/TransferModal";
            ...
            <div className="bg-white dark:bg-[#1a1f2e] rounded-[28px] p-7 h-full flex flex-col shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
                ...
                <div className="flex gap-3 mt-4">
                    <button
                        ...
                        className="flex items-center justify-center gap-2 px-7 py-3.5 bg-emerald-700 hover:bg-emerald-800 text-white rounded-full font-semibold text-sm transition-all duration-200 shadow-lg shadow-emerald-700/20"
                    >

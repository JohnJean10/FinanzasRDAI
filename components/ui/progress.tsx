...
const Progress = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & { value?: number, indicatorColor?: string }>(({ className, value, indicatorColor, ...props }, ref) => (
